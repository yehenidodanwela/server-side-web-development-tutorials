...
$prodId = isset($_GET['u_prod_id']) ? (int)$_GET['u_prod_id'] : 0;                 //see https://www.w3schools.com/php/php_superglobals_get.asp 

if ($prodId <= 0)
{
    echo "<p class='updateInfo'><b>Invalid product selected.</b></p>";
